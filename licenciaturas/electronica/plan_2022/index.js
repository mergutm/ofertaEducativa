...
fetch("../../../archivos/carreras/Electronica.json")
                        ...
                        <div class="is-flex is-justify-content-center">
                            <p class="buttons">
                                ${
                                  m.nombre == undefined
                                    ? `<div>
                                            <button id="iot_${m.optativa[0].optativa}" class="button is-small has-tooltip-arrow has-tooltip-multiline" onclick="cambioOptativa(1,'op${m.optativa[0].optativa}', '${key}', this); mostrarToast()" data-tooltip="Internet de las cosas">
                                                <span class="icon is-small">
                                                    <i class="has-text-weight-bold"> IoT </i>
                                                </span>
                                            </button>
                                            <button id="ep_${m.optativa[0].optativa}" class="button is-small has-tooltip-arrow has-tooltip-multiline" onclick="cambioOptativa(2,'op${m.optativa[0].optativa}', '${key}', this); mostrarToast()" data-tooltip="Electrónica de Potenica">
                                                <span class="icon is-small">
                                ...
                                <a class="button is-small has-tooltip-arrow has-tooltip-multiline" ${
                                  m.nombre == undefined
                                    ...
                                    : `href="../archivos/planes/plan_2022/${m.archivo}" target="_blank" download`
                                ...
                                <a class="button is-small has-tooltip-arrow has-tooltip-multiline" ${
                                  m.nombre == undefined
                                    ...
                                    : `href="../archivos/planes/plan_2022/${m.archivo}" target="_blank"`
...
function cambioOptativa(optativa, id, semestre, e) {
  ...
  const rutaInicial = "../archivos/planes/plan_2022/";
