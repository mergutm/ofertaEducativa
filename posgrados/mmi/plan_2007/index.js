...
fetch("../../../archivos/posgrados/mmi.json")
            ...
            i == semestre.length - 1 ? 'class="semestre-border"' : ""
                    ...
                    <td>
                        <div class="is-flex is-justify-content-center">
                            <p class="buttons">
                                <a class="button is-small has-tooltip-arrow has-tooltip-multiline" href="../archivos/planes/plan_2007/${
                                  m.archivo
                            ...
                            <p class="buttons">
                                ...
                                <a class="button is-small has-tooltip-arrow has-tooltip-multiline" ${
                                  m.nombre == undefined
                                    ...
                                    : `href="../archivos/planes/plan_2007/${m.archivo}" target="_blank" download`
                                ...
                                <a class="button is-small has-tooltip-arrow has-tooltip-multiline" ${
                                  m.nombre == undefined
                                    ...
                                    : `href="../archivos/planes/plan_2007/${m.archivo}" target="_blank"`
...
function cambioOptativa(optativa, id, semestre, e) {
  ...
  const rutaInicial = "../archivos/planes/plan_2007/";
